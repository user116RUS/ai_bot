# Generated by Django 4.1 on 2024-12-19 16:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_end', models.DateTimeField(verbose_name='Когда кончается подписка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_mode', to='bot.mode', verbose_name='Режим')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_mode', to='bot.user', verbose_name='Юзер')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('type', models.CharField(help_text='Хранить credit/debit/none. credit - мы потратили свои деньги. debit - мы получили деньги. none - другое', max_length=200, verbose_name='Тип транзакции')),
