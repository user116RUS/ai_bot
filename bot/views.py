...
get_ref_link = bot.message_handler(commands=["get_ref_link"])(get_ref_link)


get_ref_link = bot.callback_query_handler(lambda c: c.data.startswith('get_ref_link'))(get_ref_link)
